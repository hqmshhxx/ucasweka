 ...
 */
public interface ABCNeuralMethod extends Serializable {
   ...
   * @return The value.
   */
  double outputValue(ABCNeuralNode node);
   ...
   * @return The error.
   */
  double errorValue(ABCNeuralNode node);
   ...
   */
  void updateWeights(ABCNeuralNode node, double learn, double momentum);
